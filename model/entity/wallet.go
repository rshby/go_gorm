...
type Wallet struct {
	Id        string    `gorm:"column:id;type:varchar(100);primaryKey;not null" json:"id,omitempty"`
	UserId    string    `gorm:"column:user_id;type:varchar(100);not null" json:"user_id,omitempty"`
